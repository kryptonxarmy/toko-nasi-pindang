...
import TableChecklistKesesuaian from "@/components/my-componentAG/TableChecklistKesesuaian";
import TableDataKendaraan from "@/components/my-componentAG/TableDataKendaraan";
import TableDimensiKendaraan from "@/components/my-componentAG/TableDimensiKendaraan";
import TableKaroseriKendaraan from "@/components/my-componentAG/TableKaroseriKendaraan";
import TableKeterangan from "@/components/my-componentAG/TableKeterangan";
      ...
      <div className="flex flex-col w-full pb-10 px-[2rem] md:px-[8rem] mt-[8rem]">
        ...
        <div className="flex px-4 flex-col md:flex-row gap-8 mt-4 justify-around">
          <div className="w-full md:w-1/3">
            <img className="w-full" src="/AG_depan.jpeg" alt="depan" />
            <h1 className="text-center text-[#306cba] mt-2">TAMPAK DEPAN</h1>
          </div>
          <div className="w-full md:w-1/3">
            <img className="w-full" src="https://ujitiperb-dephub-go.id/userfiles/images/450x338-img-20240707-wa0004.jpg" alt="samping" />
            <h1 className="text-center text-[#306cba] mt-2">TAMPAK SAMPING</h1>
          </div>
          <div className="w-full md:w-1/3">
            <img className="w-full" src="https://ujitiperb-dephub-go.id/userfiles/images/450x338-img-20240707-wa0003.jpg" alt="belakang" />
